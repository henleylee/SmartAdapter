package com.liyunlong.smartadapter.recycleview.callback;
...
public abstract class DiffCallBack<DataType> extends DiffUtil.Callback {
     ...
     */
    abstract boolean areItemsTheSame(DataType oldItem, DataType newItem);
     ...
     */
    abstract boolean areContentsTheSame(DataType oldItem, DataType newItem);
     ...
     */
    abstract Bundle getChangePayload(DataType oldItem, DataType newItem);
}
